    ...
    <HeaderContentFooter background='/images/pages/welcome.png'>
      <Container>
        ...
        <Paragraph>
          ...
          общественные обязанности (доноры и другие), производят работнику выплаты в порядке и на условиях,
          которые предусмотрены настоящим Кодексом, законами и иными нормативными правовыми актами
          Приднестровской Молдавской Республики. В указанных случаях работодатель освобождает работника от
          основной работы на период исполнения государственных или общественных обязанностей.
        </Paragraph>
        <Paragraph bold>
        ...
        <ol>
          <li>
            В день сдачи крови и ее компонентов, а также в день связанного с этим медицинского обследования
          ...
          <li>
            ...
            работу (за исключением тяжелых работ и работ с вредными и (или) опасными условиями труда, когда
          ...
          <li>
            При сдаче крови и ее компонентов работодатель сохраняет за работником его средний заработок за дни
            сдачи и предоставленные в связи с этим дни отдыха.
          </li>
        </ol>
      </Container>
    </HeaderContentFooter>
